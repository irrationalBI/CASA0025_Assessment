...
First, We imported the required geometry files and perform preliminary visualization. Import satellite images and conduct test preprocessing to confirm that they can be used for subsequent analysis.
...
// ---------------------------Import data, visualization, and basic settings.---------------------------
...
// Yilan Bu: Optimized the change detection step so that the acquired image is one-way (bare ground appears)
